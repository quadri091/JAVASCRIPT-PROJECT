...
function det(params) {
    ...
    starCountRef.on('value', (snapshot) => {
        ...
        main.innerHTML = `
        <div id="preview">
            <span onclick="back()" style="display: flex; width: 35px; height: 35px; border-radius: 50%; align-items: center; justify-content: center; cursor: pointer;">
            ...
            <div class="top-prev">
                ...
                <div class="right-prev">
                    <div class="detail-pre"><b>Name: ${data.name}</b></div>
                    <div class="detail-pre"><b>Category: ${data.category}</b></div>
                    <div class="detail-pre"><b>Price: ₦${data.price.toLocaleString()}</b></div>
                    <div class="detail-pre"><b>Description: ${data.description}</b></div>
                    <div class="detail-pre"><b>Stock: ${data.stock}</b></div>
                    <div class="detail-pre"><b>Ratings: ${data.rating}</b></div>
                    <div class="detail-pre"><b>Unit: ${data.unit}</b></div>
                </div>
            </div> 
